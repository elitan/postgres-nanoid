-- Initialize the nanoid functions (dual approach: secure + sortable)
...
SELECT 'Database initialized successfully. Testing dual nanoid functions:' as status;
SELECT nanoid('test_') as secure_random_nanoid;
SELECT nanoid_sortable('test_') as sortable_nanoid;